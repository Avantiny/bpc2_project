...
public class StudentKomb extends Student {

	private String prechodnyRok;
	private String znameni;

	public StudentKomb(String jmeno, String prijmeni, int rokNarozeni, int mesicNarozeni, int denNarozeni) {
	...
	public void setZnameni() {
		...
		case 12:
			...
			break;
		default:
			System.out.println("Něco je asi špatně");
			break;
		}
	}
	...
	public String toString() {
		return "Index: " + ID + " " + jmeno + " " + prijmeni + " " + denNarozeni + "." + mesicNarozeni + "."
				+ rokNarozeni + ". Jeho ročník je " + prechodnyRok + ". Znamení studenta je: " + znameni
				+ ". Jeho průměr: " + prumer;
	}
